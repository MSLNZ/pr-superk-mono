...
class ApiDocs(Command):
    ...
    def run(self):
        command = [
            ...
            'superk_mono',  # the path to the Python package to document
        ]
...
init_original = 'superk_mono/__init__.py'
...
setup(
    ...
    url='https://github.com/MSLNZ/pr-superk-mono',
    description='Control the supercontinuum laser and monochromator via the network',
    ...
    packages=find_packages(include=('superk_mono',)),
    include_package_data=True,
    entry_points={
        'console_scripts': [
            'manager = superk_mono:start_manager',
            'service = superk_mono:start_service',
        ],
    },
)
